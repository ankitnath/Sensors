...
double baseline,baseline1; // baseline pressure
...
void setup()
{
  ...
  baseline1 = getPressure();
  
  Serial.print("baseline pressure: ");
  Serial.print(baseline);
  Serial.print("baseline pressure1: ");
...
void loop()
{
  ...
  a1 = pressure1.altitude(P1,baseline1);
...
double getPressure()
{
  ...
  status1 = pressure1.startTemperature();
  ...
  if (status != 0 && status1 != 0)
  {
    ...
    status1 = pressure1.getTemperature(T);
    if (status != 0 && status1 != 0)
    {
      ...
      status1 = pressure1.startPressure(3);
      if (status != 0 && status1 != 0)
      {
        // Wait for the measurement to complete:
        delay(status);
        ...
        status1 = pressure1.getPressure(P1,T1);
        if (status != 0 && status1 != 0)
        {
          return(P);
          return(P1);
